//Image interpolation technique using register Memory optimization
...
int main()
{
	...
	for (int i = 0, a = 0; i < img1.rows && a < img1.rows / 2; i += 2, a++)			//Shrinking of image
	{
...
//Zooming iage with Bilinear intepolation techniqu
